...
public class GlobalExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    @ExceptionHandler(ForgottenPasswordException.class)
    public ProblemDetail handleForgottenPasswordException(ForgottenPasswordException ex, HttpServletRequest request) {
    ...
    public ProblemDetail handleUserRoleException(UserRoleException ex, HttpServletRequest request) {
        ProblemDetail problemDetail = ProblemDetail.forStatusAndDetail(HttpStatus.BAD_REQUEST, ex.getMessage());
        problemDetail.setTitle("Can't find user role.");
        problemDetail.setProperty(TIMESTAMP, Instant.now().toString());
        problemDetail.setInstance(URI.create(request.getRequestURI()));
        return problemDetail;
    }
    ...
    public ProblemDetail handleProductException(ProductException ex, HttpServletRequest request) {
        ProblemDetail problemDetail = ProblemDetail.forStatusAndDetail(HttpStatus.BAD_REQUEST, ex.getMessage());
        problemDetail.setTitle("Product error occurred!");
        problemDetail.setProperty(TIMESTAMP, Instant.now().toString());
        problemDetail.setInstance(URI.create(request.getRequestURI()));
        return problemDetail;
    }
    ...
    public ProblemDetail handleProductException(MissingServletRequestPartException ex, HttpServletRequest request) {
        ProblemDetail problemDetail = ProblemDetail.forStatusAndDetail(HttpStatus.BAD_REQUEST, ex.getMessage());
    ...
    public ProblemDetail handleUnsupportedMediaTypeException(HttpMediaTypeNotSupportedException ex, HttpServletRequest request) {
